...
var require = {
    baseUrl: '/js/pointInspector',
    paths: {
        'jquery'                :'/js/lib/jquery-1.9.1.min',
        'jquery-easing'         :'/js/lib/jquery.easing.1.3',
        'jquery-hilite'         :'/js/lib/jquery-ui-1.10.4.hilite',
        ...
        'knockout.viewmodel'    :'/js/lib/knockout.viewModel',
        'lodash'                :'/js/lib/lodash.min',
        'text'                  :'/js/lib/require-text.min',
        'socket'                :'/js/lib/socket.io',
        'moment'                :'/js/lib/moment-2.9.0.min',
        'datetimepicker'        :'/js/lib/bootstrap-datetimepicker.min',
        'big'                   :'/js/lib/big.min',
        'bannerJS'              :'/js/lib/bannerJS/banner',
        'CM'                    :'/js/lib/codeMirror/codemirror.min',
        'CMMenu'                :'/js/lib/codeMirror/menu',
        'CMBrackets'            :'/js/lib/codeMirror/matchbrackets',
        'CMActiveLine'          :'/js/lib/codeMirror/active-line',
    ...
    shim: {
        'socket'                : { exports: 'io' },
        'knockout.viewmodel'    : { deps: ['knockout'] },
