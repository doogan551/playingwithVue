 ...
 */
"use strict";
dorsett.reportUI.Test = dorsett.reportUI.extend({
    Name:"dorsett.reportUI.Test",
    alias: "Test",
...
window.dorsett.reportUI.Test = new dorsett.reportUI.Test(wspace, point);
