...
(function($) {
    ...
    $.pullOutContentPanel = function(element, options) {
        ...
        //$('body').append('<a href="#" class="pocp_button"><i class="editMode fa fa-plus"></i></a>');
...
//            });
        ...
        var pocPanelShowHide = function(){
            ...
            if (!$element.hasClass('pocp_right')) {
                return $(pocPanelButton).toggleClass('btn_active').find('i').toggleClass('fa-plus fa-minus');
            }
        }
...
//            }
            $(document).on(event, function(e) {
                if ($(pocPanel).hasClass('pocp_active')) {
                    ...
                    if (!$element.hasClass('pocp_right')) {
                        $(pocPanelButton).removeClass('btn_active').find('i').toggleClass('fa-plus fa-minus');
                    }
                    if (!$element.hasClass('pocp_show')) {
                        pocPanelToggleInit();
                    }
        ...
        var pocPanelToggleInit = function(){
            ...
            if (!$element.hasClass('pocp_right')) {
                $(pocPanelToggleEl).removeClass('toggle_active').find('i').removeClass('fa-minus').addClass('fa-plus');
            }
