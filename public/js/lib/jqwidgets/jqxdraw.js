...
(function ($) {
    ...
    $.jqx.svgRenderer.prototype = {
        ...
        text: function (text, x, y, width, height, angle, params, clip, halign, valign, rotateAround) {
            ...
            //var r = this.rect(x, y, width, height, { fill: 'transparent', stroke: 'red' });
            //var c = this.circle(x + width / 2, y + height / 2, 2);
        ...
        _toLinearGradient: function (color, isVertical, stops) {
            ...
            for (var stop in stops) {
                ...
                var st = 'stop-color:' + $.jqx.adjustColor(color, stops[stop][1]);
    ...
    $.jqx.vmlRenderer.prototype = {
        ...
        _toLinearGradient: function (color, isVertical, stops) {
            ...
            for (var stop in stops) {
                if (stop > 0)
                    colors += ', ';
                colors += stops[stop][0] + '% ' + $.jqx.adjustColor(color, stops[stop][1]);
            }
