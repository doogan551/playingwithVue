...
(function ($) {
    ...
    $.extend($.jqx._jqxRangeSelector.prototype, {
        defineInstance: function () {
            ...
            this.width = 400;
            this.height = 100;
            this.min = 0; // possible values: number, date object, date string
            this.max = 100; // possible values: number, date object, date string
            this.range = { from: 0, to: Infinity, min: 0, max: Infinity }; // possible values for from and to: number, date object, date string;
            ...
            this.majorTicksInterval = 10; // possible values: number, object with one of the properties: { milliseconds, seconds, minutes, hours, days, weeks, months, years }, "millisecond", "second", "minute", "hour", "day", "week", "month", "year"
            this.minorTicksInterval = 1; // possible values: number, object with one of the properties: { milliseconds, seconds, minutes, hours, days, weeks, months, years }, "millisecond", "second", "minute", "hour", "day", "week", "month", "year"
            this.showMajorTicks = true; // possible values: true, false
            this.showMinorTicks = false; // possible values: true, false
            this.snapToTicks = true; // possible values: true, false
            this.labelsFormat = null; // possible values: for numbers: "d", "f", "n", "c", "p"; for dates: "d", "dd", "ddd", "dddd", "h", "hh", "H", "HH", "m", "mm", "M", "MM", "MMM", "MMMM", "s", "ss", "t", "tt", "y", "yy", "yyy", "yyyy"
            this.markersFormat = null; // possible values: for numbers: "d", "f", "n", "c", "p"; for dates: "d", "dd", "ddd", "dddd", "h", "hh", "H", "HH", "m", "mm", "M", "MM", "MMM", "MMMM", "s", "ss", "t", "tt", "y", "yy", "yyy", "yyyy"
            this.showLabels = true;
            this.labelsOnTicks = true;
            this.markersPosition = "top";
            this.labelsFormatFunction = null; // callback function
            this.groupLabelsFormatFunction = null; // callback function
            this.markersFormatFunction = null; // callback function
            this.showGroupLabels = false; // possible values: true, false
            this.showMarkers = true; // possible values: true, false
            this.resizable = true; // possible values: true, false
            this.moveOnClick = true; // possible values: true, false
