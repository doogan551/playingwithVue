...
(function ($) {
    ...
    $.extend($.jqx._jqxBulletChart.prototype, {
        ...
        defineInstance: function () {
            ...
            this.height = 100;
            this.barSize = "50%";
            this.ranges = [{ startValue: 0, endValue: 50, color: "#000000", opacity: 0.7 }, { startValue: 50, endValue: 80, color: "#000000", opacity: 0.5 }, { startValue: 80, endValue: 100, color: "#000000", opacity: 0.3}];
            this.pointer = { value: 65, label: "Value", size: "25%", color: "" };
            this.target = { value: 85, label: "Target", size: 4, color: "" };
            this.ticks = { position: "far", interval: 20, size: 10 }; // possible values for ticks.position: "far", "near", "both", "none"
            this.title = "Title";
            this.description = "Description";
            this.orientation = "horizontal"; // possible values: "horizontal", "vertical"
            this.labelsFormat = null; // possible values: null, "d", "f", "n", "c", "p"
            this.labelsFormatFunction = null; // callback function
            this.animationDuration = 400; // possible values: "slow", "fast" or a number in milliseconds
            this.showTooltip = true; // possible values: true, false; requires jqxtooltip.js
            this.tooltipFormatFunction = null; // callback function
