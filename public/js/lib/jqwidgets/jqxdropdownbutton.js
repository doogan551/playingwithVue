    ...
    $.extend($.jqx._jqxDropDownButton.prototype, {
        ...
        createInstance: function (args) {
            ...
            if (this.host.attr('tabindex')) {
                dropDownButtonStructure.attr('tabindex', this.host.attr('tabindex'));
        ...
        open: function () {
           ...
           if ((this.dropDownWidth == null || this.dropDownWidth == 'auto') && this.width != null && this.width.indexOf && this.width.indexOf('%') != -1) {
            ...
            this.host.addClass(self.toThemeProperty('jqx-dropdownlist-state-focus'));
            this.host.addClass(self.toThemeProperty('jqx-fill-state-focus'));
        },
