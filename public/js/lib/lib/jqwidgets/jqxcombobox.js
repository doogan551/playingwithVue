    ...
    $.extend($.jqx._jqxComboBox.prototype, {
        ...
        render: function () {
            ...
            if (this.host.attr('tabindex')) {
                this.input.attr('tabindex', this.host.attr('tabindex'));
            ...
            try {
                ...
                this.listBoxContainer.jqxListBox({
                    ...
                    checkboxes: this.checkboxes, emptyString: this.emptyString, autoBind: !this.remoteAutoComplete && this.autoBind,
