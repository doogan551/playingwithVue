                ...
                if (this.source.updaterow) {
                    ...
                    var result = function (param) {
                        ...
                        for (var i = 0; i < me.columns.records.length; i++) {
                            ...
                            var datafield = column.datafield;
                            me._raiseEvent(18, { rowindex: row, datafield: column.datafield, displayfield: column.displayfield, oldvalue: oldvalues[column.datafield], value: datarow[column.displayfield], columntype: column.columntype });
                        }
