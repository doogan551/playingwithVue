...
(function ($) {
                ...
                if (instance.createInstance != null) {
                    if (WinJS) {
                        ...
                        if (args && args[0]) {
                            ...
                            //    var setInstanceSize = function (propertyName) {
                            //        var size = null;
                            //        if (element.style[propertyName] != "") {
                            //            if (element.style[propertyName] != "auto") {
                            //                size = element.style[propertyName];
                            //            }
                            //        } else if (element.currentStyle && element.currentStyle[propertyName] != "") {
                            //            if (element.currentStyle[propertyName] != "auto") {
                            //                size = element.currentStyle[propertyName];
                            //            }
                            //        }
                            //        else if (window.getComputedStyle) {
                            //            var st = window.getComputedStyle(element, null);
                            //            var stSize = st.getPropertyValue(propertyName);
                            //            if (stSize && stSize != "" && stSize != "auto") {
                            //                size = stSize;
                            //            }
                            //        }
                            //        if (size != null) {
                            //            instance[propertyName] = size;
                            //            args[0][propertyName] = size;
                            //        }
                            //    }
                            //    if (!args[0].width) setInstanceSize("width");
                            //    if (!args[0].height) setInstanceSize("height");
                            //}
                        }
                        instance.createInstance(args);
                    }
    ...
    $.extend($.jqx.mobile,
    {
        ...
        isWindowsPhone: function () {
            var agent = navigator.userAgent.toLowerCase();
            var result = (agent.indexOf('windows phone') != -1 || agent.indexOf('WPDesktop') != -1 || agent.indexOf('ZuneWP7') != -1 || agent.indexOf('msie 9') != -1 || agent.indexOf('msie 11') != -1 || agent.indexOf('msie 10') != -1);
            return result;
        },
