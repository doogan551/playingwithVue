...
//                        if (p == 'Value') {
//                            console.log(context);
//                            console.log(!ko.isComputed(child) && !((temp = unwrap(child)) && temp.constructor === Function));
//                            console.log('computed: ' + ko.isComputed(child), 'Not: ' + temp + ' & ' + temp.constructor);
//                            console.log('');
//                        }
