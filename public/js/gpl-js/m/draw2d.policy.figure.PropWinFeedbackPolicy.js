 ...
 */
draw2d.policy.figure.PropWinFeedbackPolicy = draw2d.policy.figure.SelectionFeedbackPolicy.extend({

    NAME : "draw2d.policy.figure.PropWinFeedbackPolicy",
    /**
     * @constructor 
    ...
    init: function(){
        this._super();
        var box = new draw2d.shape.icon.Phone(10,10);
        box.setCanvas(this);
        //box.shape.toFront();
        //box.show(this.canvas);

        //var r3 = new draw2d.ResizeHandle(this.figure, 3); // 3 = RIGHT_TOP
        //this.figure.selectionHandles.add(r3);
        //r3.show(this.canvas);
        
        //r3.setDraggable(this.figure.isResizeable());
            
        //if (this.figure.isResizeable() === true)
        //{
        ...
        //this.moved(this.canvas, this.figure);
   },
    ...
    onSelect: function(canvas, figure, isPrimarySelection) {
        ...
        console.log(figure.selectionHandles.isEmpty());
