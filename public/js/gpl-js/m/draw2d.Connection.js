    ...
    **/
    ...
    repaint:function(attributes)
    {
      ...
      this._super(attributes);
	    ...
	    //
	    if(this.sourceDecoratorNode!==null){
	    	var start = this.getVertices().get(0);
        ...
        if(this.targetDecoratorNode!==null){
	    	var end = this.getVertices().getLastElement();
 ...
 */
draw2d.Connection.DEFAULT_ROUTER= new draw2d.layout.connection.InteractiveManhattanConnectionRouter();
